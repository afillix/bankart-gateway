...
use Afillix\BankartGateway\Data\CreditCardCustomer;
use Afillix\BankartGateway\Data\Customer;
use Afillix\BankartGateway\Data\IbanCustomer;
use Afillix\BankartGateway\Data\Request;
use Afillix\BankartGateway\Exception\InvalidValueException;
use Afillix\BankartGateway\Schedule\ScheduleData;
use Afillix\BankartGateway\Exception\TypeException;
...
class Generator {
    ...
    /**
     * @param \Afillix\BankartGateway\Transaction\VoidTransaction $transaction
     * @param $method
     *
     * @return \DOMElement
     */
