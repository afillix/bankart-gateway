...
namespace Afillix\BankartGateway;

use Afillix\BankartGateway\CustomerProfile\CustomerData;
use Afillix\BankartGateway\CustomerProfile\DeleteProfileResponse;
use Afillix\BankartGateway\CustomerProfile\GetProfileResponse;
use Afillix\BankartGateway\CustomerProfile\PaymentInstrument;
use Afillix\BankartGateway\CustomerProfile\UpdateProfileResponse;
use Afillix\BankartGateway\Json\ErrorResponse;
use Afillix\BankartGateway\Exception\RateLimitException;
use Afillix\BankartGateway\Schedule\ScheduleData;
use Afillix\BankartGateway\Exception\ClientException;
use Afillix\BankartGateway\Exception\InvalidValueException;
use Afillix\BankartGateway\Exception\TimeoutException;
use Afillix\BankartGateway\Http\CurlClient;
use Afillix\BankartGateway\Http\Response;
use Afillix\BankartGateway\StatusApi\StatusRequestData;
use Afillix\BankartGateway\Transaction\Base\AbstractTransaction;
use Afillix\BankartGateway\Transaction\Capture;
use Afillix\BankartGateway\Transaction\Debit;
use Afillix\BankartGateway\Transaction\Deregister;
use Afillix\BankartGateway\Transaction\Payout;
...
use Afillix\BankartGateway\Transaction\VoidTransaction;
use Afillix\BankartGateway\Xml\Generator;
use Afillix\BankartGateway\Xml\Parser;
 ...
 * Class Client
 *
 * @package Afillix\BankartGateway
 */
class Client {
     ...
     *
     * @param \Afillix\BankartGateway\Transaction\VoidTransaction $transactionData
     *
     * @return Result
     * @throws ClientException
     * @throws InvalidValueException
