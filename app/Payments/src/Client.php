...
namespace App\Payments\src;

use App\Payments\src\CustomerProfile\CustomerData;
use App\Payments\src\CustomerProfile\DeleteProfileResponse;
use App\Payments\src\CustomerProfile\GetProfileResponse;
use App\Payments\src\CustomerProfile\PaymentInstrument;
use App\Payments\src\CustomerProfile\UpdateProfileResponse;
use App\Payments\src\Json\ErrorResponse;
use App\Payments\src\Exception\RateLimitException;
use App\Payments\src\Schedule\ScheduleData;
use App\Payments\src\Exception\ClientException;
use App\Payments\src\Exception\InvalidValueException;
use App\Payments\src\Exception\TimeoutException;
use App\Payments\src\Http\CurlClient;
use App\Payments\src\Http\Response;
use App\Payments\src\StatusApi\StatusRequestData;
use App\Payments\src\Transaction\Base\AbstractTransaction;
use App\Payments\src\Transaction\Capture;
use App\Payments\src\Transaction\Debit;
use App\Payments\src\Transaction\Deregister;
use App\Payments\src\Transaction\Payout;
use App\Payments\src\Transaction\Preauthorize;
use App\Payments\src\Transaction\Refund;
use App\Payments\src\Transaction\Register;
use App\Payments\src\Transaction\Result;
use App\Payments\src\Transaction\VoidTransaction;
use App\Payments\src\Xml\Generator;
use App\Payments\src\Xml\Parser;
...
class Client {
     ...
     *
     * @param \App\Payments\src\Transaction\VoidTransaction $transactionData
     *
     * @return Result
     * @throws ClientException
     * @throws InvalidValueException
